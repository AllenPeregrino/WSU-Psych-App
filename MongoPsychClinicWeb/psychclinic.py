...
def initDB(*args, **kwargs):
    ...
    if Thoughtsnegative.objects.count() == 0:
        thoughtsneg = ['This is not interesting. I don’t find this engaging at all.',
                    'Someone or something is getting in my way. This is interfering with what I want.',
                    'I have a different point of view. I disagree.',
                    'I was hoping for better. That was not what I wanted.',
                    'This situation is not what I expected. I never would have guessed that this would happen.',
                    ...
                    'This was beyond anyone’s control. No one could’ve prevented this from happening.',
                    'I dont know whether I can handle what is happening or about to happen. I might not be able to deal with it. Something bad might happen.',
                    'I won’t be able to handle what is happening or about to happen. I know that I won’t be able to deal with it.',
                    ...
                    'I am to blame for this bad situation. I’ve done something wrong.',
