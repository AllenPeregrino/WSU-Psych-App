...
from app.report_generator.automated_responses import get_redcap_survey
import traceback
import pandas as pd
...
def generate_report():
    try:
        ...
        csv_file_path = get_redcap_survey(save_path=save_survey_path)
        print(f"Full REDCap CSV saved at: {csv_file_path}")
        ...
        print(f"Report generated using CSV: {csv_file_path}")
